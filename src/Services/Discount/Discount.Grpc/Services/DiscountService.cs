    ...
    public class DiscountService : DiscountProtoService.DiscountProtoServiceBase
    {
            ...
            ServerCallContext context)
        {
            ...
            _logger.LogInformation("Discount is retrieved for ProductName: {productName} " +
                "with amount {amount}", coupon.ProductName, coupon.Amount);
            ...
            ServerCallContext context)
        {
            ...
            _logger.LogInformation("Discount is successfully created. PorudctName: {productName}",
                coupon.ProductName);
            ...
            ServerCallContext context)
        {
            ...
            _logger.LogInformation("Discount is successfully updated. PorudctName: {productName}",
                coupon.ProductName);
